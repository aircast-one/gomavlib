...
import (
	"github.com/aircast-one/gomavlib/v4/pkg/dialects/minimal"
)
...
const (
	...
	// Radio #1.
	MAV_COMP_ID_RADIO MAV_COMPONENT = minimal.MAV_COMP_ID_RADIO
	// Radio #2.
	MAV_COMP_ID_RADIO2 MAV_COMPONENT = minimal.MAV_COMP_ID_RADIO2
	// Radio #3.
	MAV_COMP_ID_RADIO3 MAV_COMPONENT = minimal.MAV_COMP_ID_RADIO3
	// Servo #1.
